...
const Navbar: React.FC<NavbarProps> = ({ selectedSection, onSectionChange }) => {
  ...
  return (
    <>
      ...
      {/* Mobile Bottom Navigation - Home/Dashboard Page */}
      {isMobile && location.pathname === '/' && currentWallet.isConnected && currentWallet.isRegistered && !isModalOpen && (
        <Paper
          sx={{
            position: 'fixed',
            bottom: 0,
      ...
      {/* Mobile Bottom Navigation - Referrers Page */}
      {isMobile && location.pathname === '/referrers' && currentWallet.isConnected && currentWallet.isRegistered && !isModalOpen && (
        <Paper
          sx={{
            position: 'fixed',
            bottom: 0,
